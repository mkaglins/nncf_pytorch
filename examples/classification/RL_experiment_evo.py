...
from examples.classification.LeGR_evolution import evolution_agent_train, LeGREvolutionEnv, EvolutionOptimizer
    ...
    for LOSS in [False]:
        for coeff in coeff_range:
            ...
            while isinstance(model, nn.DataParallel):
                model = model.module
            evolution_agent_train(LeGREvolutionEnv, EvolutionOptimizer, ((train_loader, val_loader), LeGRPruner(model, compression_ctrl, 'L1'), model, 0.8,  100), {})
